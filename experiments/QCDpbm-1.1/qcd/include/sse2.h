...
* inline assembly SSE2 instructions
*
*******************************************************************************/
...
static sse_int _sse_sgn_dble __attribute__ ((unused)) ={0x0,0x80000000,0x0,0x0};
...
/******************************************************************************
*
*  Macros for the linalg_dble routines
*
******************************************************************************/
...
/*
*  Computes z*s where s is an su3_vector_dble and z a complex number. It is
*  assumed that s is in xmm0,xmm1,xmm2 and that z has been loaded by
*  _sse_load_cmplx_dble(z). The result appears in xmm3,xmm4,xmm5
*/

#define _sse_mulc_dble() \
__asm__ __volatile__ ("movapd %%xmm0, %%xmm3 \n\t" \
                      "movapd %%xmm1, %%xmm4 \n\t" \
                      "movapd %%xmm2, %%xmm5 \n\t" \
                      "mulpd %%xmm6, %%xmm0 \n\t" \
                      "mulpd %%xmm6, %%xmm1 \n\t" \
...
/*
*  Computes r+z.re*s where r and s are of type su3_vector_dble and z a
*  complex number. It is assumed that r is in xmm3,xmm4,xmm5, s in
*  xmm0,xmm1,xmm2 and that z has been loaded by _sse_load_cmplx_dble(z)
*/

#define _sse_add_mulc_re_dble() \
...
/*
*  Computes r+i*z.im*s where r and s are of type su3_vector_dble and z a
*  complex number. It is assumed that r is in xmm3,xmm4,xmm5, s in
*  xmm0,xmm1,xmm2 and that z has been loaded by _sse_load_cmplx(z)
*/

#define _sse_add_mulc_im_dble() \
