...
int main(void)
{
   ...
   error(a1==NULL,1,"main [check8.c]","Unable to allocate auxiliary arrays");
   ...
   for (n=1;n<=NMAX;n++)
   {
      ...
      error((mdev(n,a1,a2)!=0.0)||(vdev(n,v1,v2)!=0.0),1,"main [check8.c]",
      ...
      error((mdev(n,a1,a2)!=0.0)||(mdev(n,b1,b2)!=0.0),1,"main [check8.c]",
      ...
      error(mdev(n,a1,a2)!=0.0,1,"main [check8.c]",
