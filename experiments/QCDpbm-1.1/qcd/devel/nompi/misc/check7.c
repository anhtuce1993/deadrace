...
int main(void)
{
   ...
   error(a1==NULL,1,"main [check7.c]","Unable to allocate auxiliary arrays");
   ...
   for (n=1;n<=NMAX;n++)
   {
      ...
      error((mdev(n,a1,a2)!=0.0f)||(vdev(n,v1,v2)!=0.0f),1,"main [check7.c]",
      ...
      error((mdev(n,a1,a2)!=0.0f)||(mdev(n,b1,b2)!=0.0f),1,"main [check7.c]",
      ...
      error(mdev(n,a1,a2)!=0.0f,1,"main [check7.c]",
