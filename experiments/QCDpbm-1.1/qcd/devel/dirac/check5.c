...
* License (GPL)
*
* Action of Qhat_dble on plane waves
*
*******************************************************************************/
...
int main(int argc,char *argv[])
{
   ...
   int np[4],bo[4];
   float ran[4];
   double m0,csw,mp,d,pi,p[4],sp[4],px,r,*rs;
   complex_dble z;
   ...
   if (my_rank==0)
   {
      ...
      printf("\n");
      printf("Action of Qhat_dble on plane waves\n");
      printf("----------------------------------\n\n");
   ...
   sw_term();
   error(invert_swd(ODD_PTS)!=0,1,"main [check5.c]",
