...
* License (GPL)
*
* Gauge covariance of Qnohat_dble
*
*******************************************************************************/
...
int main(int argc,char *argv[])
{
   ...
   if (my_rank==0)
   {
      flog=freopen("check4n.log","w",stdout);
      printf("\n");
      printf("Gauge covariance of Qnohat_dble (random fields)\n");
      printf("-----------------------------------------------\n\n");
   ...
   error((g==NULL)||((BNDRY>0)&&(gbuf==NULL)),1,"main [check4n.c]",
